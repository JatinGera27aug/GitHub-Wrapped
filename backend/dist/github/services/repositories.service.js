...
let RepositoriesService = class RepositoriesService {
    ...
    async getTopRepositories(username) {
        const { data: repos } = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`https://api.github.com/users/${username}/repos?sort=stars&per_page=6`, {
            headers: {
